export const evidenceSections = {
  formula: { label: 'Original Source', fields: ['product_url', 'image_url', 'ingredient_list', 'formula_verification_status', 'review_status', 'notes', 'variant_formulas', 'primary_market'] },
